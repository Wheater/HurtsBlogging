...
exports.getLastModTest = function(test){
	...
	test.equal(sitemap.getLastMod(new Date(2015, 07, 10, 03, 35, 15))
				, '<lastmod>2015-08-10-T03:35:15+00:00</lastmod>'
				, "last mod xml");
...
exports.getLocTest = function(test){
	test.equal(sitemap.getLoc('singlePost', 10)
		     , '<loc>http://hurtsblogging.com/views/singlePost/10</loc>'
		     , 'returns valid loc entry');
	//throws has to call a function from a function block --LAME
	test.throws(function(){sitemap.getLoc(null, 10);}, "no type provided", "no type throws exception");
	test.throws(function(){sitemap.getLoc('singlePost', -10)}, "no id provided", "no id throws exception");
	test.throws(function(){sitemap.getLoc('singlePost', null)}, "no id provided", "no id throws exception");
	test.done();
}
/*
 * add tests here...
...
exports.getNewFileDataTest = function(test){
	test.equal(sitemap.getNewFileData('singlePost', 10, xmlFile, new Date(2015, 07, 10, 03, 35, 15))
			 , correctXmlFile
